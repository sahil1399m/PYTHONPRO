...
APP_FOOTER = "Built by TEAM KGS | VJTI"
...
def verify_college(c):
    return c.strip().lower() == "vjti" or "veermata jijabai technological institute"
...
st.caption("Enter details to Verify — good luck!")
...
if st.session_state.user is None:
    ...
    with col_center:
        ...
        with st.form("login_form"):
            ...
            regid = st.text_input(
                "🆔 Registration ID (must start with 24109)")
